...
public class RoomTypeController {
    ...
    public ModelAndView list(ModelAndView model){
        model.setViewName("admin/room_type/list");
        return model;
    }
    /**
     * 房间类型信息添加操作
     ...
     */
    @SysLog(value = "房间类型添加")
    @RequiresPermissions("room_type:add")
     ...
     */
    @SysLog(value = "房间类型编辑")
    @RequiresPermissions("room_type:edit")
    ...
    public Map<String, String> edit(RoomType roomType){
        ...
        RoomType existRoomType = roomTypeService.findRoomType(roomType.getId());
    ...
    public Map<String,Object> list(
        ...
        PageInfo pageInfo = new PageInfo(roomTypeService.findRoomTypeList(name,status));
     ...
     */
    @SysLog(value = "房间类型删除")
    @RequiresPermissions("room_type:delete")
