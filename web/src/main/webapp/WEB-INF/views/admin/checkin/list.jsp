...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        <div class="wu-toolbar-button">
            <shiro:hasPermission name="checkin:add">
                <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="openAdd()" plain="true">添加入住信息</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="checkin:edit">
                <a href="#" class="easyui-linkbutton" iconCls="icon-bullet-edit" onclick="openEdit()" plain="true">修改入住信息</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="checkin:delete">
                <a href="#" class="easyui-linkbutton" iconCls="icon-cross" onclick="openCheckOut()" plain="true">退房</a>
            </shiro:hasPermission>
        </div>
...
<script type="text/javascript">
	...
	*/
	...
	$("#search-btn").click(function(){
		...
		var roomId = $("#search-room").combobox('getValue');
