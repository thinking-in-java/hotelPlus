...
<head>
    ...
    <script type="text/javascript" src="${path}/static/admin/js/jquery-3.2.1.min.js"></script>
    <style>
...
<script type="text/javascript" src="${path}/static/admin/js/personalFile.js"></script>
