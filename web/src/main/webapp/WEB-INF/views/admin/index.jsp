...
<head>
    ...
    <link rel="stylesheet" href="${path}/static/admin/layui/css/layui.css" media="all" />
    <link rel="stylesheet" href="${path}/static/admin/css/iconfont1/iconfont.css" media="all">
    <link rel="stylesheet" href="${path}/static/admin/css/index.css" media="all" />
    <style type="text/css">
        /*#box0 {*/
            /*overflow-x: hidden;*/
            /*overflow-y: scroll;*/
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main">
            <a href="${path}/index" class="logo"><img src="${path}/static/admin/images/BM.png"></a>
            <!-- 显示/隐藏菜单 -->
...
<script type="text/javascript" src="${path}/static/admin/layui/layui.js"></script>

<script type="text/javascript" src="${path}/static/admin/js/index.js"></script>

<script type="text/javascript" src="${path}/static/admin/js/leftNav.js"></script>
</body>
</html>
