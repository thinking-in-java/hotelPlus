...
<head>
	...
	<meta name="copyright" content="All Rights Reserved, Copyright (C) 2020, James Ben, Ltd." />
...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${staticPath}/orderPay/pay" method=post
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		document.getElementById("WIDout_trade_no").value =  ${book_orderId};
		document.getElementById("WIDsubject").value = "${book_orderName}";
		document.getElementById("WIDtotal_amount").value = ${order_Prices};
	}
	GetDateNow();
</script>
</html>