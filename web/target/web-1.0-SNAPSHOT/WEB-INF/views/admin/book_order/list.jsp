...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        <div class="wu-toolbar-button">
            <shiro:hasPermission name="book_order:add">
                <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="openAdd()" plain="true">添加</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="book_order:edit">
        ...
        <div class="wu-toolbar-search">
            ...
            <label>支付状态:</label>
            <select id="search-payStatus" class="easyui-combobox" panelHeight="auto" style="width:120px">
                <option value="-1">全部</option>
	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    <select id="add-payStatus" name="payStatus" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择状态'">
                        <option value="0">未支付</option>
                        <option value="1">已支付</option>
                    </select>
                </td>
        ...
        <table>
           <tr>
            ...
            <tr>
                <td align="right">支付状态:</td>
                <td>
                    <select id="edit-payStatus" name="payStatus" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择状态'">
                        <option value="0">未支付</option>
                        <option value="1">已支付</option>
                    </select>
                </td>
...
<script type="text/javascript">
	...
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
                ...
                $("#edit-payStatus").combobox('setValue',item.payStatus);
	...
	*/
	...
	$("#search-btn").click(function(){
		...
		var payStatus = $("#search-payStatus").combobox('getValue');
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
            ...
            { field:'payStatus',title:'支付状态',width:100,formatter:function(value,row,index){
                    switch(value){
                        case 0:{
                            return '未支付';
                        }
