...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        <div class="wu-toolbar-button">
            <shiro:hasPermission name="room_type:add">
                <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="openAdd()" plain="true">添加</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="room_type:edit">
                <a href="#" class="easyui-linkbutton" iconCls="icon-bullet-edit" onclick="openEdit()" plain="true">编辑</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="room_type:delete">
                <a href="#" class="easyui-linkbutton" iconCls="icon-cross" onclick="remove()" plain="true">删除</a>
            </shiro:hasPermission>
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td valign="middle">
                	<img id="preview-photo" style="float:left;" src="${staticPath }/static/admin/images/home.jpg" width="100px">
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="photo" value="${staticPath }/static/admin/images/home.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td width="60" align="right">图片预览:</td>
                <td valign="middle">
                	<img id="edit-preview-photo" style="float:left;" src="${staticPath }/static/images/mz.jpg" width="100px">
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">房型图片:</td>
                <td><input type="text" id="edit-photo" name="photo" value="${staticPath }/static/images/mz.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
           <tr>
                <td align="right">名称:</td>
...
function upload(){
	...
	$.ajax({
		url:'${staticPath}/upload/upload_photo',
		type:'post',
		data:formData,
		contentType:false,
		processData:false,
