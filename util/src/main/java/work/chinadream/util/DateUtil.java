...
public class DateUtil {
    private static Logger LOGGER = Logger.getLogger(work.chinadream.util.DateUtil.class);
    ...
    public static String getLastMonth(Date data) {
        ...
        return work.chinadream.util.DateUtil.getStringDate(date,work.chinadream.util.DateUtil.DateFormat2);
    }
