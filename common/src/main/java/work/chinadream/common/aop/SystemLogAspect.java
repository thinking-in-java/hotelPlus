...
import work.chinadream.util.WebUtils;
...
public  class SystemLogAspect {
    ...
    //本地异常日志记录对象
    private  static  final Logger logger = LoggerFactory.getLogger(work.chinadream.common.aop.SystemLogAspect. class);

    //Controller层 切点
    @Pointcut("@annotation(work.chinadream.common.aop.SysLog)")
             ...
             if (method.getName().equals(methodName)) {
                Class[] clazzs = method.getParameterTypes();
                 if (clazzs.length == arguments.length) {
                    description = method.getAnnotation(work.chinadream.common.aop.SysLog.class).value();
                    break;
                }
            }
        }
